...
export const mockHarvardEvents = [
    new Event({
        ...
        location: "Harvard Innovation Labs, Allston, MA",
    ...
    new Event({
        ...
        location: "Sanders Theatre, Cambridge, MA",
        host: "Veritas Forum",
    ...
    new Event({
        ...
        location: "Harvard Hall, Cambridge, MA",
    ...
    new Event({
        ...
        location: "Memorial Hall, Cambridge, MA",
    ...
    new Event({
        ...
        location: "Harvard Science Center, Cambridge, MA",
    ...
    new Event({
        ...
        summary: "A showcase of artwork from graduate students in the Harvard Art Department.",
    ...
    new Event({
        ...
        location: "Harvard Science Center Plaza, Cambridge, MA",
    ...
    new Event({
        ...
        location: "Barker Center, Cambridge, MA",
    ...
    new Event({
        ...
        location: "Student Organization Center at Hilles (SOCH), Cambridge, MA",
